...
//polopu 1 uses pins 2 and 5 
//pololu 2 uses pins 3 and 6 
...
#define lowSwitch 4   // pin 4 para final de carrera inferior
#define upSwitch 7   //pin 7 para fin de carrera superior
...
int direccion =6;  //toma el valor de el pin DIR del pololu diferente en cada antena
int pololu =3;    //toma el valor de el pin STEP del pololu diferente en cada antena
...
void loop(){ 
  ...
  display.display();
  delay(1000);
  display.print("2 LOOPS OLED 128X32"); 
  display.display();
  delay(2000);
  display.clearDisplay();
  display.display();
